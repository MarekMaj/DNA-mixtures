...
/**
 * <p>Java class for mixture complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="mixture">
 *   &lt;complexContent>
...
@XmlType(name = "mixture", propOrder = {
...
public class Mixture {
    ...
    @Generated(value = "com.sun.tools.internal.xjc.Driver", date = "2012-01-24T03:28:20+01:00", comments = "JAXB RI vJAXB 2.1.10 in JDK 6")
    protected List<MixtureMarker> marker;
    ...
    public List<MixtureMarker> getMarker() {
        if (marker == null) {
            marker = new ArrayList<MixtureMarker>();
        }
        return this.marker;
    }
